...
class Mailbox
{
     ...
     */
    public function __construct(string $imapPath, string $login, string $password, string $attachmentsDir = null, string $serverEncoding = 'US-ASCII', bool $trimImapPath = true, bool $attachmentFilenameMode = false)
    {
